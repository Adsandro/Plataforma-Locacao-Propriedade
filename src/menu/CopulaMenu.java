...
public class CopulaMenu {
    ...
    public static void implementaUsuario(List<Usuario> listaUsuarios){
    ...
    public static void implementaPropriedade(List<Propriedade> listaPropriedades, List<Usuario> listaUsuarios){
